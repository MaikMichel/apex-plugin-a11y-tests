...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9843003234983149)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9843587971983150)
,p_plugin_attribute_id=>wwv_flow_imp.id(9843003234983149)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9844105197983151)
,p_plugin_attribute_id=>wwv_flow_imp.id(9843003234983149)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9844760054983151)
,p_plugin_attribute_id=>wwv_flow_imp.id(9843003234983149)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9845368696983152)
,p_plugin_id=>wwv_flow_imp.id(7495045313819567)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(9843003234983149)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9845868442983152)
,p_plugin_id=>wwv_flow_imp.id(7495045313819567)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9846332777983152)
,p_plugin_id=>wwv_flow_imp.id(7495045313819567)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9846802721983153)
,p_plugin_id=>wwv_flow_imp.id(7495045313819567)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9847355692983153)
,p_plugin_id=>wwv_flow_imp.id(7495045313819567)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9847892032983153)
,p_plugin_attribute_id=>wwv_flow_imp.id(9847355692983153)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9848491292983154)
,p_plugin_attribute_id=>wwv_flow_imp.id(9847355692983153)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9849003668983154)
,p_plugin_attribute_id=>wwv_flow_imp.id(9847355692983153)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9849614779983154)
,p_plugin_attribute_id=>wwv_flow_imp.id(9847355692983153)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9850289382983155)
,p_plugin_id=>wwv_flow_imp.id(7495045313819567)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9850735527983155)
,p_plugin_attribute_id=>wwv_flow_imp.id(9850289382983155)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9851377374983156)
,p_plugin_attribute_id=>wwv_flow_imp.id(9850289382983155)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9851936024983156)
,p_plugin_attribute_id=>wwv_flow_imp.id(9850289382983155)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9852501086983157)
,p_plugin_attribute_id=>wwv_flow_imp.id(9850289382983155)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9853197033983157)
,p_plugin_attribute_id=>wwv_flow_imp.id(9850289382983155)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9853789700983157)
,p_plugin_attribute_id=>wwv_flow_imp.id(9850289382983155)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9854392058983158)
,p_plugin_attribute_id=>wwv_flow_imp.id(9850289382983155)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9854922014983158)
,p_plugin_id=>wwv_flow_imp.id(7495045313819567)
,p_attribute_scope=>'COMPONENT'
