...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(7325733656819495)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9428927765982984)
,p_page_template_id=>wwv_flow_imp.id(7325733656819495)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9429425892982984)
,p_page_template_id=>wwv_flow_imp.id(7325733656819495)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9429927274982984)
,p_page_template_id=>wwv_flow_imp.id(7325733656819495)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9430419350982985)
,p_page_template_id=>wwv_flow_imp.id(7325733656819495)
,p_name=>'Body Footer'
