...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7390088992819520)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9590166537983047)
,p_plug_template_id=>wwv_flow_imp.id(7390088992819520)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9590625438983047)
,p_plug_template_id=>wwv_flow_imp.id(7390088992819520)
,p_name=>'Sub Regions'
