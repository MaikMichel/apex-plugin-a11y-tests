...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7429657869819533)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9694010660983087)
,p_plug_template_id=>wwv_flow_imp.id(7429657869819533)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9694521326983087)
,p_plug_template_id=>wwv_flow_imp.id(7429657869819533)
,p_name=>'Tabs'
