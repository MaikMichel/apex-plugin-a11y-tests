...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7354655561819508)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9500051197983011)
,p_plug_template_id=>wwv_flow_imp.id(7354655561819508)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9500525914983011)
,p_plug_template_id=>wwv_flow_imp.id(7354655561819508)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9501059957983011)
,p_plug_template_id=>wwv_flow_imp.id(7354655561819508)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9501538866983011)
,p_plug_template_id=>wwv_flow_imp.id(7354655561819508)
,p_name=>'Sub Regions'
