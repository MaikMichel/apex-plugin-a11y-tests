...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7353252007819507)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9496149372983009)
,p_plug_template_id=>wwv_flow_imp.id(7353252007819507)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9496633459983010)
,p_plug_template_id=>wwv_flow_imp.id(7353252007819507)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9497160290983010)
,p_plug_template_id=>wwv_flow_imp.id(7353252007819507)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9497620694983010)
,p_plug_template_id=>wwv_flow_imp.id(7353252007819507)
,p_name=>'Sub Regions'
