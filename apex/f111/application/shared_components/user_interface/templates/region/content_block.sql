...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9571938403983040)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9572415109983041)
,p_plug_template_id=>wwv_flow_imp.id(7381953702819518)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9572953121983041)
,p_plug_template_id=>wwv_flow_imp.id(7381953702819518)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9573491825983041)
,p_plug_template_id=>wwv_flow_imp.id(7381953702819518)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9573950070983041)
,p_plug_template_id=>wwv_flow_imp.id(7381953702819518)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9574463893983041)
,p_plug_template_id=>wwv_flow_imp.id(7381953702819518)
,p_name=>'Sub Regions'
