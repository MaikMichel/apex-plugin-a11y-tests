...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8917957107964565)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8918475955964566)
,p_plugin_attribute_id=>wwv_flow_imp.id(8917957107964565)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8919011537964566)
,p_plugin_attribute_id=>wwv_flow_imp.id(8917957107964565)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8919641244964567)
,p_plugin_attribute_id=>wwv_flow_imp.id(8917957107964565)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8920279126964567)
,p_plugin_id=>wwv_flow_imp.id(12097954993755061)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8917957107964565)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8920749267964568)
,p_plugin_id=>wwv_flow_imp.id(12097954993755061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8921205188964568)
,p_plugin_id=>wwv_flow_imp.id(12097954993755061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8921710661964569)
,p_plugin_id=>wwv_flow_imp.id(12097954993755061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8922210881964569)
,p_plugin_id=>wwv_flow_imp.id(12097954993755061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8922790035964569)
,p_plugin_attribute_id=>wwv_flow_imp.id(8922210881964569)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8923318788964569)
,p_plugin_attribute_id=>wwv_flow_imp.id(8922210881964569)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8923946445964570)
,p_plugin_attribute_id=>wwv_flow_imp.id(8922210881964569)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8924538367964570)
,p_plugin_attribute_id=>wwv_flow_imp.id(8922210881964569)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8925119590964570)
,p_plugin_id=>wwv_flow_imp.id(12097954993755061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8925617382964571)
,p_plugin_attribute_id=>wwv_flow_imp.id(8925119590964570)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8926254900964571)
,p_plugin_attribute_id=>wwv_flow_imp.id(8925119590964570)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8926813700964571)
,p_plugin_attribute_id=>wwv_flow_imp.id(8925119590964570)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8927421841964572)
,p_plugin_attribute_id=>wwv_flow_imp.id(8925119590964570)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8928081118964572)
,p_plugin_attribute_id=>wwv_flow_imp.id(8925119590964570)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8928658813964572)
,p_plugin_attribute_id=>wwv_flow_imp.id(8925119590964570)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8929272313964572)
,p_plugin_attribute_id=>wwv_flow_imp.id(8925119590964570)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8929819302964573)
,p_plugin_id=>wwv_flow_imp.id(12097954993755061)
,p_attribute_scope=>'COMPONENT'
