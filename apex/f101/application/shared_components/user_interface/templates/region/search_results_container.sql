...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11956555390755002)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11956824515755003)
,p_plug_template_id=>wwv_flow_imp.id(11956555390755002)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11957172336755003)
,p_plug_template_id=>wwv_flow_imp.id(11956555390755002)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11957475624755003)
,p_plug_template_id=>wwv_flow_imp.id(11956555390755002)
,p_name=>'Sub Regions'
