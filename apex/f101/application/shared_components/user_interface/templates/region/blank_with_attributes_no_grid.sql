...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12030106526755024)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12030425784755024)
,p_plug_template_id=>wwv_flow_imp.id(12030106526755024)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12030795303755024)
,p_plug_template_id=>wwv_flow_imp.id(12030106526755024)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12031091945755024)
,p_plug_template_id=>wwv_flow_imp.id(12030106526755024)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12031376292755024)
,p_plug_template_id=>wwv_flow_imp.id(12030106526755024)
,p_name=>'Sub Regions'
