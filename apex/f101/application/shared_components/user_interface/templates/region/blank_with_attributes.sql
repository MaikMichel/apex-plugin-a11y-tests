...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12041309320755027)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12041661068755027)
,p_plug_template_id=>wwv_flow_imp.id(12041309320755027)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12041900964755027)
,p_plug_template_id=>wwv_flow_imp.id(12041309320755027)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12042224178755027)
,p_plug_template_id=>wwv_flow_imp.id(12041309320755027)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12042550556755027)
,p_plug_template_id=>wwv_flow_imp.id(12041309320755027)
,p_name=>'Sub Regions'
