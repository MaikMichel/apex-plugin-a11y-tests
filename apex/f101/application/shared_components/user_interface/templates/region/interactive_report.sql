...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8717291165964450)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8717796858964450)
,p_plug_template_id=>wwv_flow_imp.id(11979058535755009)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8718237097964450)
,p_plug_template_id=>wwv_flow_imp.id(11979058535755009)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8718767543964451)
,p_plug_template_id=>wwv_flow_imp.id(11979058535755009)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8719218135964451)
,p_plug_template_id=>wwv_flow_imp.id(11979058535755009)
,p_name=>'Sub Regions'
