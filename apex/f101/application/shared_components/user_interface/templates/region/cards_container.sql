...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(11976932551755008)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11977241343755008)
,p_plug_template_id=>wwv_flow_imp.id(11976932551755008)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11977560755755008)
,p_plug_template_id=>wwv_flow_imp.id(11976932551755008)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11977821686755008)
,p_plug_template_id=>wwv_flow_imp.id(11976932551755008)
,p_name=>'Sub Regions'
