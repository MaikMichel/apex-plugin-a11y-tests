...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11920220794754974)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11920504680754978)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11920854034754979)
,p_page_template_id=>wwv_flow_imp.id(11920220794754974)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11921137781754979)
,p_page_template_id=>wwv_flow_imp.id(11920220794754974)
