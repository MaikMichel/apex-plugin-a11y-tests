...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(11927135026754986)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11927449280754986)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11927786701754986)
,p_page_template_id=>wwv_flow_imp.id(11927135026754986)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(11928065120754986)
,p_page_template_id=>wwv_flow_imp.id(11927135026754986)
